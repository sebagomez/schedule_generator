...
const TRANSLATIONS = {
  es: {
    ...
    hintPointer: 'Para intercambiar días: hacé clic en "Intercambiar días" y después elegí un día de trabajo y uno libre. Hacé clic derecho en cualquier día para más opciones (marcar como trabajo/libre, deshacer, bloquear). Hacé clic en un día marcado (🔀/✏️) para deshacerlo rápido. Un día bloqueado (rayas rojas) no se puede cambiar hasta desbloquearlo.',
    hintTouch: 'Para intercambiar días: tocá "Intercambiar días" y después elegí un día de trabajo y uno libre. Tocá cualquier día para ver las opciones (marcar como trabajo/libre, deshacer, bloquear). Un día bloqueado (rayas rojas) no se puede cambiar hasta desbloquearlo.',
    ...
    errLock: 'No se pudo guardar el bloqueo. ¿Está corriendo el servidor?',
    errLocked: 'Ese día está bloqueado. Desbloquealo primero.',
    errLockedDate: 'El {date} está bloqueado. Desbloquealo primero.',
    titleSwapped: 'Día intercambiado: tocá para deshacer',
    titleManual: 'Día editado manualmente: tocá para deshacer',
    titleLocked: 'Día bloqueado: desbloquealo para poder cambiarlo',
  ...
  en: {
    ...
    hintPointer: 'To swap days: click "Swap Days", then pick one work day and one off day. Right-click any day for more options (mark as work/off, undo, lock). Click a marked day (🔀/✏️) to quickly undo it. A locked day (red stripes) cannot be changed until you unlock it.',
    hintTouch: 'To swap days: tap "Swap Days", then pick one work day and one off day. Tap any day for options (mark as work/off, undo, lock). A locked day (red stripes) cannot be changed until you unlock it.',
    ...
    errLock: 'Could not save the lock. Is the server running?',
    errLocked: 'That day is locked. Unlock it first.',
    errLockedDate: '{date} is locked. Unlock it first.',
    titleSwapped: 'Swapped day - tap to undo',
    titleManual: 'Manually edited day - tap to undo',
    titleLocked: 'Locked day - unlock it before changing it',
  ...
  it: {
    ...
    hintPointer: 'Per scambiare i giorni: clicca "Scambia giorni", poi scegli un giorno di lavoro e uno libero. Clicca con il tasto destro su un giorno per altre opzioni (segna come lavoro/libero, annulla, blocca). Clicca su un giorno segnato (🔀/✏️) per annullarlo rapidamente. Un giorno bloccato (righe rosse) non si può cambiare finché non lo sblocchi.',
    hintTouch: 'Per scambiare i giorni: tocca "Scambia giorni", poi scegli un giorno di lavoro e uno libero. Tocca un giorno qualsiasi per le opzioni (segna come lavoro/libero, annulla, blocca). Un giorno bloccato (righe rosse) non si può cambiare finché non lo sblocchi.',
    ...
    errLock: 'Impossibile salvare il blocco. Il server è attivo?',
    errLocked: 'Quel giorno è bloccato. Sbloccalo prima.',
    errLockedDate: 'Il {date} è bloccato. Sbloccalo prima.',
    titleSwapped: 'Giorno scambiato: tocca per annullare',
    titleManual: 'Giorno modificato manualmente: tocca per annullare',
    titleLocked: 'Giorno bloccato: sbloccalo per poterlo cambiare',
